...
KMCUDAResult kmeans_cuda_yy(
    ...
    udevptrs<uint32_t> *assignments, 
    udevptrs<uint32_t> *assignments_yy,
    udevptrs<float> *centroids_yy,
    //udevptrs<float> *bounds_yy,
    udevptrs<float> *drifts_yy, udevptrs<uint32_t> *passed_yy);
    //udevptrs<int16_t> *mark_threads_yy, udevptrs<uint32_t> *calculate_point_yy, udevptrs<uint32_t> *calculate_centroid_yy,
    //udevptrs<uint32_t> *mark_cpu_yy, udevptrs<uint32_t> *mark_gpu_yy
